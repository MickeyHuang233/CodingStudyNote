#💻編程/🌠Java/05_JavaSE加強 
# 無向圖 Graph
![image](https://upload-images.jianshu.io/upload_images/4064751-9ef7887aca675269.png?imageMogr2/auto-orient/strip|imageView2/2/w/526/format/webp)
...
![image](https://cdn.jsdelivr.net/gh/zhyjc6/My-Pictures/2020/03/20200311113240.png)

## 🧠鄰接表 Adjacency List
對於圖中的每個頂點，將儲存所有其它與之相連的頂點
![image](https://img-blog.csdn.net/20150127162704390?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvbGVpY29vbF81MTg=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
...
# 有向圖 Digraph
![image](https://i.stack.imgur.com/Z2bqd.png)
- 常見術語：
	- 出度：由某個頂點指出邊的個數
	- 入度：指向某個頂點的邊個數
...
==拓扑排序 = 有環判斷 + 頂點排序==
![image](https://web.ntnu.edu.tw/~algo/TopologicalOrdering3.png)
...
### 樹的性質
![image](https://codertw.com/wp-content/uploads/img/ORvIHDV93Z.jpg)
1. 用一條邊接樹中任意兩個頂點都會得到一個環
2. 任意刪除一個邊，會得到兩個獨立的樹

### 切分定理
![image](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTC3uWhR-B126GtxgjiLhW3h2kBHuKT71gv5Q&usqp=CAU)
- 相關概念：
	- 切分：把圖中頂點分成兩個部分
...
![image](https://img-blog.csdnimg.cn/b4f0da0f79644139ab5dcaa51c0c2944.png?x-oss-process=image/watermark,type_ZHJvaWRzYW5zZmFsbGJhY2s,shadow_50,text_Q1NETiBA6auY6auYZm9yIOW-queOrw==,size_10,color_FFFFFF,t_70,g_se,x_16)
![image](https://img-blog.csdnimg.cn/acb002509fd24e8e9c1ee000ee87d4f8.png?x-oss-process=image/watermark,type_ZHJvaWRzYW5zZmFsbGJhY2s,shadow_50,text_Q1NETiBA6auY6auYZm9yIOW-queOrw==,size_8,color_FFFFFF,t_70,g_se,x_16)
![image](https://img-blog.csdnimg.cn/ff38821d570a4377aacbbba0bbe5e351.png?x-oss-process=image/watermark,type_ZHJvaWRzYW5zZmFsbGJhY2s,shadow_50,text_Q1NETiBA6auY6auYZm9yIOW-queOrw==,size_9,color_FFFFFF,t_70,g_se,x_16)

### Prim算法
將最小生成樹中的頂點看作一部分，而不在最小生成樹看作另一部分，每個步驟將一個頂點加入到最小生成樹中
![image](https://img-blog.csdnimg.cn/8d6cffe36ae149df8c070c03a9f98e42.png?x-oss-process=image/watermark,type_ZHJvaWRzYW5zZmFsbGJhY2s,shadow_50,text_Q1NETiBA6auY6auYZm9yIOW-queOrw==,size_20,color_FFFFFF,t_70,g_se,x_16)
