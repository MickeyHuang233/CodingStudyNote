...
![[數據結構算法_04_樹_01_樹大致結構.png]]

# 二叉樹 Binary tree
每個節點最多只有兩個分支
![[數據結構算法_04_樹_02_二叉樹.png]]
...
### 刪除結點邏輯
![[數據結構算法_04_樹_03_二叉查找樹刪除結點邏輯.png]]
...
### 折紙問題
- 問題描述：
	![[數據結構算法_04_樹_04_折紙問題.png]]
- 分析為程序問題：
	- 根節點為下節點
	- 所有節點的左子節點都為下折痕
	- 所有節點的右子節點都為上折痕
	- 以中序遍歷打印折衰
	![[數據結構算法_04_樹_05_折紙問題解決邏輯.png]]
...
- 特點：
	1. 堆為完全二叉樹；除最後一層可以不滿外，其他每一層都都必須是滿的；若最後一層不是滿的，則必須左滿右不滿
		![[數據結構算法_04_樹_06_完全二叉樹.png]]
	2. 通常表現為數組
		- 若節點為`list[k]`，則子節點為`list[2k]`和`list[2k+1]`
		![[數據結構算法_04_樹_07_堆數組.png]]
