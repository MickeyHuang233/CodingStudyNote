...
- NTLM驗證流程圖
	![[駭客實務入門_06_系統入侵_01_NTLM驗證流程圖.png]]
- NTLM AD驗證流程圖，基本流程一致，只是密碼保存、驗證在DC端，Server端僅傳送請求、結果
	![[駭客實務入門_06_系統入侵_02_NTLM AD驗證流程圖.png]]
...
![[駭客實務入門_06_系統入侵_03_Kerberos.png]]
...
- Cain and Abel，Microsoft Windows的密碼恢復工具。它可以使用網絡數據包嗅探等方法恢復多種密碼，使用字典攻擊，強力攻擊和密碼分析攻擊等多種方法破解各種密碼哈希。密碼分析攻擊是通過彩虹表完成的，該彩虹表可以使用Cain和Abel提供的winrtgen.exe程序生成
	...
	![[駭客實務入門_06_系統入侵_06_CainAndAbel.png]]
...
![[駭客實務入門_06_系統入侵_11_離線應用程式大致架構.png]]
...
### Windows Event Log
![[駭客實務入門_06_系統入侵_12_WindowsEventLog.png]]
